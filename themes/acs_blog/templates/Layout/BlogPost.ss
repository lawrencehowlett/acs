		...
		<aside class="left">
			<div class="widget">
				<ul class="blog-social">
					...
					<li><span class='social googleplus st_googleplus_custom' displayText='Tweet'></span></li>
					<li><span class='social twitter st_twitter_custom' displayText='LinkedIn'></span></li>
					<li><span class='social linkedin st_linkedin_custom' displayText='Google +'></span></li>
				</ul>				
			</div>
		</aside>
